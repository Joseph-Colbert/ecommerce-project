...
@Component({
  selector: 'app-poduct-list-enterprise',
  templateUrl: './product-list-enterprise.component.html',
  styleUrls: ['./product-list-enterprise.component.css']
})
export class ProductListEnterpriseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.routerService.routeSource.next(this.route);
